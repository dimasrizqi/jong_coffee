...
<head>
    ...
    <title>{{ config('app.name', "Cigombong Coffee") }}</title>
...
<body id="@yield('bodyID')">
    ...
    <footer>
                ...
                <div class="footer-detail">
                    ...
                    <div class="media-link">
                        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                         ...
                         <a target="_blank" href = "https://www.instagram.com/cigombongkoffie/"><p>@Cigombong Coffee</p></a>
                    </div>
                    <div class="media-link">
                        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <hr>
        <div class="copyright">
            <p>Copyright © 2022 All Rights Reserved by Cigombong Coffee, Powered By PT CEMERLANG DIGITAL TECHINDO.</p>
        </div>
